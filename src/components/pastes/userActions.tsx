...
export const UserActions = ({ refid, pasteid }: PasteUserActionsProps) => {
  ...
  return (
    <>
      <button onClick={handleUpdatePaste} className="bg-white h-6 w-6 mx-1 hover:text-primary-500" title="Update paste">
      ...
      <button onClick={handleRemovePaste} className="bg-white h-6 w-6 mx-1 hover:text-primary-500" title="Delete paste">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
